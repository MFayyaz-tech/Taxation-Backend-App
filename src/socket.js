...
//   console.log("Socket.IO server listening on port 3104")
// );

// const taxationBotSocket = require("./resources/taxation_bot_chat/taxationBotSocket");
// const taxationKeyWordsModel = require("./resources/taxation_bot_chat/taxationKeyWordsModel");
// const chatSocket = require("./resources/chat/chatSocket");
...
//     taxationBotSocket(socket, io); // Ensure that taxationBotSocket is correctly handling bot events
...
module.exports = (server) => {
  ...
  // Make io accessible through the app
  const app = require("./app");
  app.set("io", io);
